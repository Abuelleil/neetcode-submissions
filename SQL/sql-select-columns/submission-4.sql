...
ALTER TABLE comments RENAME COLUMN author TO comment_author;

ALTER TABLE comments RENAME COLUMN body TO comment_body;

-- SELECT author AS comment_author, body AS comment_body  FROM comments
SELECT comment_author, comment_body  FROM comments